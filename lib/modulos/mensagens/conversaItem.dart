...
class conversaItem extends StatefulWidget {
  final Conversa mensagens;
  conversaItem(this.mensagens);
...
class _conversaItemState extends State<conversaItem> {
  ...
  Widget build(BuildContext context) {
    var b64 = (widget.mensagens.anuncio.fotos.isNotEmpty)
        ? widget.mensagens.anuncio.fotos[0]['foto_codigo']
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(widget.mensagens.anuncio.titulo,
            style: _tema.textTheme.headlineMedium?.copyWith()),
        subtitle: Text(
          widget.mensagens.anuncio.usuario,
          style: _tema.textTheme.displayMedium?.copyWith(),
        ),
        onTap: () async {
          // await widget.mensagens.verificaFavorito(context);
          ...
          Navigator.of(context).pushNamed(
            AppRoutes.conversaMensagem,
            arguments: widget.mensagens,
          );
        },
      ),
    );
